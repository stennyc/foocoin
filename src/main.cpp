...
uint256 hashGenesisBlock("0x95bdf8fe4119d698eb5533b34ebd8abd36cf83e0813596a231db50474bebdec7");
...
const string strMessageMagic = "mysen Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // mysen: 1 days
static const int64 nTargetSpacing = 90; // mysen: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal mysen miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "mysen", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe88882f0f0fbd23f707afed10f2d6ed0668f826ac8b7c0ae85f9b2c7c79d447f");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1501684196; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 4031832;

        if (fTestNet)
        {
            block.nTime    = 1501602066;
            block.nNonce   = 4031832;
        }
